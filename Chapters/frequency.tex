...
\begin{figure}[!h]
  ...
  \end{subfigure}
\setcounter{figure}{2}
\captionof{figure}{Words denoting gender-nonconform individuals in the Pali Canon and Commentaries.}
\label{pali1}
\end{figure}
...
\begin{figure}[!h]
  ...
  \end{subfigure}
\setcounter{figure}{3}
\captionof{figure}{Percentage of importance of words within the collection.}
\label{pali2}
\end{figure}
...
\begin{figure}[!h]
  ...
  \end{subfigure}
\setcounter{figure}{4}
\captionof{figure}{Words denoting gender-nonconform individuals in the Sanskrit Buddhist and Vedic Canons and Commentaries.}
\label{sanskrit1}
\end{figure}
...
\begin{figure}[!h]
  ...
  \end{subfigure}
\setcounter{figure}{6}
\captionof{figure}{Total number of words denoting gender-nonconform individuals in the Chinese Taishō Canon.}
\label{chinese1}
\end{figure}
...
\begin{figure}[!h]
  ...
  \end{subfigure}
\setcounter{figure}{8}
\captionof{figure}{Words denoting gender-nonconform individuals in the Tibetan Kangyur and Tengyur Canon.}
\label{tibetan1}
\end{figure}
...
\captionof{figure}{Percentage of importance in relation to the root words within the collection.}
\label{itthi3}
\end{figure}
...
\captionof{figure}{Percentage of importance of denoting sex/gender-characteristics in relation to the root word 根 (faculty) within the collection.}
\label{chinese5}
\end{figure}
...
\captionof{figure}{Percentage of importance of denoting sex/gender-characteristics in relation to the root word 形 (shape) within the collection.}
\label{chinese6}
\end{figure}